...
st.sidebar.markdown('** Step 1 :**Testing parameters...')
...
if condation3 !=True :
	...
	pass
st.sidebar.markdown('** Step 2:** Preprocessing...')
...
st.write('')
time.sleep(1)
st.sidebar.markdown('** Step 3:** Finding best Model...')
with st.spinner('Wait for it...'):
...
st.write('')
time.sleep(1)
st.sidebar.markdown('** Step 4:**Fitting Training data...')
with st.spinner('Wait for it...'):
...
st.sidebar.markdown('** Final step:** Model Testing ...')
...
if condationTEST :
	...
	time.sleep(2)
	st.write('values of  Testing parameters:')
